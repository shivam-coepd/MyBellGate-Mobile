...
class GuardVisitorManagementScreen extends StatefulWidget {
  ...
  const GuardVisitorManagementScreen({super.key, this.isBackButton = false});
...
class _VisitorManagementScreenState
                ...
                return RefreshIndicator(
                  ...
                  child: Padding(
                    padding: EdgeInsets.only(
                      left: 16.w,
                      right: 16.w,
                      top: (widget.isBackButton) ? 0 : 16.h,
                    ),
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        if (!widget.isBackButton) SizedBox(height: 15.h),
                        GridView.builder(
                          shrinkWrap: true,
                        ...
                        // Visitor List with shimmer loading
                        Expanded(
                          child: isLoading
                              ? _buildVisitorListShimmer()
                              : visitors.isEmpty
                              ? Center(
                                  child: Column(
  ...
  /// Shimmer loading effect for visitor list cards
  Widget _buildVisitorListShimmer() {
    final theme = Theme.of(context);
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 12.h),
                  // Action buttons shimmer (for pending status)
                  Row(
                    children: [
                      Expanded(
                        child: Container(
