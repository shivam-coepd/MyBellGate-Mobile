...
//         File(image.path),
//         folder: S3UploadService.folderFamily,
//       );
...
//                       decoration: BoxDecoration(
//                         color: _isUploading ? Colors.grey : theme.primaryColor,
//                         borderRadius: BorderRadius.circular(16),
//                       ),
//                       child: Text(
//                         _isUploading ? 'UPLOADING...' : (_uploadedImageUrl != null ? 'UPLOADED ✓' : 'ADD'),
...
//     });
//     try {
//       // Vehicle images are uploaded but not yet wired to a backend field;
//       // the URL is available for future use.
//       await _s3.uploadImage(File(image.path), folder: S3UploadService.folderVehicles);
//     } catch (e) {
//       if (mounted) {
//         ScaffoldMessenger.of(context).showSnackBar(
//           SnackBar(content: Text('Image upload failed: $e'), backgroundColor: Colors.red),
